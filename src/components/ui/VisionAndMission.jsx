            ...
            <section id="vision" className="py-10 bg-gray-50">
                <div className="container mx-auto px-4">
                    <div className="flex flex-col gap-4">
                        {/* Vision */}
                        <div className={`${bgColor} flex items-center justify-between px-2 py-4 rounded-lg shadow-lg text-center max-sm:flex-col max-sm:gap-6`}>
                        ...
                        {/* Mission */}
                        <div id="mission" className={`${bgColor} flex items-center justify-between px-2 py-4 rounded-lg shadow-lg text-center max-sm:flex-col max-sm:gap-6`}>
                            <div className="max-w-60ch">
